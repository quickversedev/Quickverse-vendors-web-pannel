      ...
      <div className="space-y-5">
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="pt-0.5">
            <h4 className="text-sm font-bold text-zinc-100 tracking-wide">All Day Closed</h4>
            <p className="text-[11px] text-zinc-400 font-medium mt-0.5">Close store operations for an entire day</p>
          </div>
        </div>
